    ...
    public partial class NewLogin : System.Web.UI.Page
    {
        ...
        protected void SUBMIT_Click_AddPer(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string sql = "INSERT INTO login (username, passwrd, ID) VALUES (@username, @passwrd, @doctorID)";
                ...
                {
                    string sql = "INSERT INTO login (username, passwrd, ID) VALUES (@username, @passwrd, @nurseID)";
                    MySqlCommand command = new MySqlCommand(sql, connection);
                    command.Parameters.AddWithValue("@username", username.Text);
                    command.Parameters.AddWithValue("@passwrd", password.Text);
