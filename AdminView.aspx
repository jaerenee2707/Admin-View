            ...
            <div class="form-container">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="id" runat="server" placeholder="0000" MaxLength="4" />
                        <asp:RegularExpressionValidator ID="id" runat="server" ControlToValidate="id" ValidationExpression="^\d{10}$" ErrorMessage="Please enter a valid id number" />
                    </div>
            ...
            <script>
                ...
                $(function () {
                    ...
                    $('#<%=SUBMIT.ClientID %>').on('click', function () {
                        ...
                        if ($('#<%=username.ClientID %>').val() === '' || $('#<%=password.ClientID %>').val() === '' || $('#<%=ID.ClientID %>').val() === ''
                        {
                            // Display dialog box
